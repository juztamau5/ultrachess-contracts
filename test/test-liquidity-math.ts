...
describe("Liquidity math", () => {
  ...
  const ASSET_TOKENS_BOUGHT = ethers.BigNumber.from("409497122600816315"); // About 0.409 asset tokens

  // Asset tokens are unstaked from the Curve Aave gauge
  const CURVE_AAVE_GAUGE_UNSTAKED = ethers.BigNumber.from("991896818235748812"); // About 0.992 gauge shares
  ...
  const FINAL_ASSET_RESERVES = ethers.BigNumber.from("1007845342489160785"); // About 1.008 asset tokens
